...
Proof.
  ...
  transitivity z.
  - apply H1.
  - assert (H3 : y :: l = z :: l). { transitivity j. apply H2. apply eq2. }
    injection H3 as H4. symmetry. apply H4.
Qed.
(** [] *)
...
Proof.
  ...
  assert (H : n = p). { transitivity m. apply eq1. apply eq2. }
  rewrite H.
  apply eqb_refl.
Qed.
(** [] *)
...
Proof.
  ...
  - destruct l1 as [| h1 t1].
    ...
    + destruct l2 as [| h2 t2].
      ...
      ++ intros eq1 eq2.
         simpl in eq1.
         injection eq1 as eq10 eq11 eq12.
         simpl in eq2.
         injection eq2 as eq20.
         apply IHl' in eq12.
         simpl.
         rewrite eq12.
         rewrite eq10.
